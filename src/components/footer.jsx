...
function footer() {
  return (
    <div className="flex flex-col justify-center px-10 mx-19">
       ...
       <div className="bawah flex justify-between my-10">
        <div className="kiri items-center text-center bg-[#2a3342] py-25 px-30 rounded-lg">
        <h2 className="text-4xl text-white font-bold ">Radar Teknologi</h2>
        <div className="flex flex-row items-center gap-2">
        <img src="logo.png" alt="" className="logo w-15"/>
        <h1 className="text-5xl text-white font-bold">Komputer</h1>
        </div>
        </div>
